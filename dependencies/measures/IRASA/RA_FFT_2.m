...
% function rafft = amri_sig_fractal(sig,srate,varargin)
% 
% if nargin<2
...
% [Smixd, Sfrac, freq] = irasa(sig,srate,nfft,flag_filter);  
% 
% 
...
function [Smixd, Sfrac, freq] = RA_FFT_2(sig,srate,nfft,flag_filter)
